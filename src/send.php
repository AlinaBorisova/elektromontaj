...
$toAdress   = 'b-alina1999.borisova@yandex.ru';       //  кому

//pvd@smart-conversion.ru
// info@elektromontagnye-raboty.ru
...
$types   = array('jpg', 'png', 'gif', 'bmp', 'jpeg', 'doc', 'docs', 'pdf', 'rtf', 'txt', 'rar', 'zip', 'xlsx', 'xls');
...
<script type="text/javascript">
  function changeurl(){eval(self.location="https://conversion-test.ru/thanks/");}
